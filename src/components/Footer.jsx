    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <img src="/icon/logo.png" alt="FranhiCode" className="footer-logo-img" />
              <span className="footer-brand-name">FranhiCode</span>
            </div>
            ...
            <div className="footer-available">
              ...
              <span>Available for work — Junior roles welcome</span>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} FranhiCode. All rights reserved.</p>
          <p className="footer-credit">Built with React + Vite · Designed with ❤️</p>
        </div>
      </div>
    </footer>
  );
