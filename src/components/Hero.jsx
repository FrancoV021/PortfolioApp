      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Building <strong>scalable full-stack applications</strong> with Java & React,
            accelerated by <strong>AI workflows</strong>. Turning complex problems into
          ...
          <div className="hero-socials">
            {SOCIAL_LINKS.map((s) => (
              <a
                key={s.name}
                href={s.url}
                target={s.name !== 'Email' ? '_blank' : '_self'}
